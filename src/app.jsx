...
const autoGenerateDates = async () => {
    ...
    // 1. Jours fériés via l'algorithme
    ...
    try {
      // Formatage strict pour l'API v2.1 (ex: "Zone+A")
      const zoneFormattee = zone.replace(' ', '+');
      
      // Nouvelle URL avec le double filtre (Zone ET Année scolaire) pour forcer les bons résultats
      ...
      // 2. PLAN DE SECOURS (Anti-panne si l'API est vide pour la rentrée 2026)
